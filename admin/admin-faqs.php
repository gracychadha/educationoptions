...
<head>
	...
	<title>FAQs - Dumra Consulting - Education and Migration Experts</title>
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<div class="ms-2">
															<p class="text-dark mb-0"><?php echo $rowfaqs['question']; ?></p>
														</div>
													</div>
												</td>
												<td><?php echo $rowfaqs['answer']; ?></td>
												<td>
												...
												<td><?php echo $rowfaqs['created_at']; ?></td>
												<td>
													<div class="d-flex align-items-center">
