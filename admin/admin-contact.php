...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    elseif (isset($_POST['action']) && $_POST['action'] === 'edit-id' && isset($_POST['idcontact'])) {
        ...
        if (empty($errors)) {
            $sql_update = "UPDATE contact SET name = ?, phone = ?, email = ?, message = ?,subject=? WHERE idcontact = ?";
            $stmt = $db->prepare($sql_update);
            $stmt->bind_param('sssssi', $name, $phone, $email, $message,$subject, $id);
...
<head>
    ...
    <title>Contact Messages - Education Options</title>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="btn btn-outline-light bg-white btn-icon d-flex align-items-center justify-content-center rounded-circle edit-btn p-0 me-2" data-bs-toggle="modal"
                                                            ...
                                                            data-subject="<?php echo htmlspecialchars($rowcontact['service']); ?>"
                    ...
                    <form action="admin-contact.php" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="edit-phone" name="phone" pattern="(\+91[6-9][0-9]{9}|[6-9][0-9]{9})" title="Indian phone number: +91 followed by 10 digits starting with 6-9, or 10 digits starting with 6-9" required>
                            </div>
                               <div class="mb-3">
