...
<head>
    ...
    <title>Our Team || Education Options</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <link rel="manifest" href="site.webmanifest">
    <link rel="shortcut icon" type="image/x-icon" href="assets/img/eo/favicon.png">
                 ...
                 <div class="col-xxl-4 col-lg-6">
                     <div class="topheader-info">
                         ...
                         <div class="header-location f-right">
                             <ul>
                                 <li><i class="flaticon-pin"></i><a href="contact-us.php">Our Location</a></li>
                             </ul>
                         </div>
                     </div>                  
                 </div>
    ...
    <div class="container">
        <div class="row white-color inner-team">
            ...
            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6">
                <div class="team text-center mb-35">
                    <div class="team__thumb team__thumb-2 mb-25">
                        <img src="assets/img/team/t-5.jpg" alt="">
                        <div class="team__thumb-info">
                            <div class="team-social">
                                <a href="#"><i class="fab fa-facebook-f"></i></a>
                                <a href="#"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="team__text">
                        <h3 class="team__text-title">
                            <a href="team-details.html">Dana Holly Joya</a> 
                        </h3>
                        <span>Manager, Visapass</span>
                    </div>
                </div>
            </div>
            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6">
                <div class="team text-center mb-35">
                    <div class="team__thumb team__thumb-2 mb-25">
                        <img src="assets/img/team/t-6.jpg" alt="">
                        <div class="team__thumb-info">
                            <div class="team-social">
                                <a href="#"><i class="fab fa-facebook-f"></i></a>
                                <a href="#"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="team__text">
                        <h3 class="team__text-title">
                            <a href="team-details.html">Linkon Dicruse</a> 
                        </h3>
                        <span>Sr. Consultant</span>
                    </div>
                </div>
            ...
            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6">
                <div class="team text-center mb-35">
                    <div class="team__thumb team__thumb-2 mb-25">
                        <img src="assets/img/team/t-7.jpg" alt="">
                        <div class="team__thumb-info">
                            <div class="team-social">
                                <a href="#"><i class="fab fa-facebook-f"></i></a>
                                <a href="#"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="team__text">
                        <h3 class="team__text-title">
                            <a href="team-details.html">Jonathon Deoya</a> 
                        </h3>
            ...
            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6">
                <div class="team text-center mb-35">
                    <div class="team__thumb team__thumb-2 mb-25">
                        <img src="assets/img/team/t-8.jpg" alt="">
                        <div class="team__thumb-info">
                            <div class="team-social">
                                <a href="#"><i class="fab fa-facebook-f"></i></a>
                                <a href="#"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="team__text">
                        <h3 class="team__text-title">
                            <a href="team-details.html">Morgan D Sliva</a> 
                        </h3>
...
<!-- abbrand-area start -->
<div class="abbrand-area pt-80 pb-120 wow fadeInUp" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
    <div class="container">
                        ...
                        <div class="footer__widget-content">
                            <div class="footer__services">
                                <ul>
                                    ...
                                    <li><a href="contact-us.php">Payment Type</a></li>
                        ...
                        <div class="footer__widget-content">
                            <div class="footer__services">
                                <ul>
                                    ...
                                    <li><a href="contact-us.php">Permanent Residence Visas</a></li>
